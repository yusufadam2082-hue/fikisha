...
data class Order(
    ...
    @SerializedName("deliveryFee") val deliveryFee: Double,
    @SerializedName("itemsSubtotal") val itemsSubtotal: Double? = null,
    @SerializedName("platformFee") val platformFee: Double? = null,
    @SerializedName("discountAmount") val discountAmount: Double? = null,
    @SerializedName("merchantNetIncome") val merchantNetIncome: Double? = null,
    @SerializedName("customerTotal") val customerTotal: Double? = null,
